            ...
            <div className="h-max w-[350px] bg-black border-none rounded-md flex flex-col gap-4 justify-center items-center px-6 py-8 shadow-lg">
                {(!stepVerify && !stepPassword) && (
                    <>
                        ...
                        <div onClick={handleNavigateSendEmail} className="text-sm ml-auto text-white hover:text-blue-400 hover:ease-in-out transition-colors duration-300 cursor-pointer">
                            Forgot Password?
                        </div>
                ...
                {(stepPassword) && (
                    <>
                        ...
                        <button onClick={handleChangePassword} className=' w-full h-max p-1 bg-gradient text-black rounded-lg font-semibold text-lg'>
                            Change password
                        </button>
                    </>
                )}

...
import {
    LuLayoutTemplate, LuShapes, LuFolder, LuImage,
} from "react-icons/lu";
...
const WorkplacePage = () => {
    ...
    const setBackground = (bgLink) => {
        if (currentCanvas !== null) {
            setBackgrounds((prev) => ({
                ...prev, [currentCanvas]: bgLink || "white",
            }));
        }
    };
    ...
    const removeElement = (id) => {
        ...
        setCanvases((prevCanvas) => prevCanvas.map((canvas) => canvas.id === currentCanvas ? {
                    ...
                    <div className="h-full w-[calc(100%-75px)]">
                        <div
                            ...
                            <div
                                ...
                                className={`flex absolute justify-center items-center w-[20px] -right-2 top-[40%] cursor-pointer h-[100px] rounded-full ${isDarkMode ? "bg-white text-slate-700" : "bg-[#252627] text-slate-300"}`}>
                                <MdKeyboardArrowLeft/>
                            </div>

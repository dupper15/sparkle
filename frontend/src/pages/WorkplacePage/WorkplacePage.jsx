...
import TextToolbar from "../../components/SharedComponents/PropertyBars/TextToolBar.jsx";
...
const WorkplacePage = () => {
    ...
    const [textToolBarState, setTextToolBarState] = useState(false);
    const [imageToolBarState, setImageToolBarState] = useState(false);
    ...
    const testTextToolBar=()=>{
        setTextToolBarState((prev)=>!prev)
    }
    const testImageToolBar=()=>{
        setImageToolBarState((prev)=>!prev)
    }
            ...
            <div className='flex h-[calc(100%-60px)] w-screen scrollbar-hide'>
                ...
                <div className='h-full w-[calc(100%-75px)]'>
                    ...
                    <div
                        ...
                        <div className='inline-flex p-x-'>
                            <button className='bg-amber-200 m-2' onClick={testTextToolBar}>Text</button>
                            <button className='bg-amber-200 m-2' onClick={testImageToolBar}>Image</button>
                        </div>
                        <div className='relative h-[100px] w-full'>
                            {
                                (imageToolBarState) &&
                                <div className='z-50 absolute top-[0rem] right-[20rem]'>
                                    <ImageToolbar></ImageToolbar>
                                </div>
                            }
                            {
                                (textToolBarState) &&
                                <div className='z-50 absolute top-[0rem] right-[19rem]'>

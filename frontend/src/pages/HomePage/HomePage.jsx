...
const HomePage = () => {
	...
	return (
		<div className={`h-screen flex flex-col overflow-y-auto ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
				...
				<div className='w-[calc(100%-80px)] flex flex-col h-full pb-5 '>
					...
					<div className=''>
						<div className='flex justify-between items-center mx-10 my-2'>
							<div className='ml-2 text-2xl font-bold w-max pointer-events-none'>Your recent design</div>
							<Link to='../project' className=' text-right underline font-bold hover:text-[#4335DE]' href=''>
								See all
							</Link>
						</div>
						<div className='px-8'>
					...
					<div className=''>
						<div className='flex justify-between items-center mx-10 my-2'>
							<div className='ml-2 text-2xl font-bold w-max pointer-events-none'>Hot Trending</div>
							<Link to='../template' className=' text-right underline font-bold hover:text-[#4335DE]' href=''>
								See all
							</Link>
						</div>
						<div className='px-8'>

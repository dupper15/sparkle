		...
		<div className='flex flex-col h-screen overflow-y-auto bg-white dark:bg-black'>
			...
			<div className='flex flex-grow w-auto'>
				...
				<div className='flex flex-col w-[calc(100%-50px)] md:w-[calc(100%-80px)] overflow-y-auto gap-4 pb-8 ps-14 pe-20 scrollbar-hide text-slate-900 bg-white dark:bg-black dark:text-white'>
					<span className='font-bold text-xl md:text-3xl mt-4 pointer-events-none'>My Profile</span>
					<div>
						<span className='font-semibold text-xl pointer-events-none'>Avatar</span>
						<div className='flex items-center justify-between mt-4'>
							<label htmlFor='upload-avatar' className='cursor-pointer'>
								<img className='object-cover w-[100px] h-[100px] rounded-full' src={image} alt='Profile Avatar' />
							</label>
							<div className='flex flex-col text-right cursor-pointer space-y-2'>
								<label className='md:text-m hover:text-[#4335DE] cursor-pointer' htmlFor='image'>
									Change image
								</label>
								<input
									type='file'
						...
						{isViewImage && (
							<div
								...
								onClick={closeModal}
							>
								<div className='bg-white rounded shadow-lg relative' onClick={(e) => e.stopPropagation()}>
									<img src={image} alt='Profile Image' className='object-fill w-[640px] h-[360px] rounded' />
								</div>
							</div>
						)}
						...
						<div className='flex items-center justify-between w-full'>
							<div className='flex flex-col space-y-2'>
								<span className='font-semibold text-xl pointer-events-none'>Nickname</span>
								{isEditingUserName ? (
									<input
										type='text'
						...
						<div className='flex flex-col justify-between w-full space-y-2'>
							<span className='font-semibold text-xl pointer-events-none'>Email</span>
							<span className='font-thin text-s md:text-m pointer-events-none'>{user.email}</span>
						</div>
						<div className='w-full h-[1px] bg-gray-400 my-4'></div>
						<div className='flex items-center justify-between w-full'>
							<div className='flex flex-col space-y-2'>
								<span className='font-semibold text-xl pointer-events-none'>Password</span>
							</div>
							<button
								className='w-[auto] h-[40px] font-semibold rounded-lg border-slate-600  border-2 shadow-sm flex justify-center items-center px-3 py-2 hover:bg-slate-100 bg-white text-slate-800 dark:bg-black dark:text-white'
						...
						<div className='w-full h-[1px] bg-gray-400 my-4'></div>
						<div className='flex flex-col space-y-2'>
							<span className='font-semibold text-xl pointer-events-none'>Social Media</span>
							<span className='font-thin text-s  pointer-events-none'>Services you have used</span>
						</div>
							...
							<div className='flex flex-col sm:flex-row items-center border-slate-600 w-full h-auto border rounded-lg my-2 py-3 px-2 dark:border-white'>
								<div className='flex flex-row items-center w-full sm:w-auto'>
									...
									<div className='flex flex-col px-4'>
										<span className='font-semibold text-lg sm:text-xl pointer-events-none'>Google</span>
			...
			{isChangePassword && <FormChangePassword closeForm={() => setChangePassword(false)} />}
		</div>
	);
};

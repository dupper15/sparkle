                ...
                >
                       ...
                       {project.canvasArray?.[0]?.componentArray?.map((component, index) => {
                        const getShapeStyle = (shapeType) => {
                            ...
                            case 'triangle':
                                return { clipPath: 'polygon(50% 0, 100% 100%, 0 100%)' }; // Hình tam giác
                            case 'invertedTriangle':
                                return { clipPath: 'polygon(50% 100%, 0 0, 100% 0)' }; // Hình tam giác ngược
                            case 'pentagon':
                                return { clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }; // Hình ngũ giác
                            case 'hexagon':
                                return { clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }; // Hình lục giác
                            case 'octagon':
                                return {

...
const ColorPickerPanel = ({
  ...
  return (
    <div className="color-picker-panel w-80 bg-white text-black dark:bg-black dark:text-white rounded-lg shadow-lg p-4 font-sans">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-medium">Color</h2>
        <button
          className="text-2xl text-gray-500 hover:text-orange-700"

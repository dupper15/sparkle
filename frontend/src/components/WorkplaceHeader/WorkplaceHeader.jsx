  ...
  return (
    <div
      ...
      <div className='flex items-center gap-2'>
        <div className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] bg-[url('./assets/logo.png')] bg-cover bg-center" />
        <div
          onClick={goHome}
      ...
      <div className='flex items-center gap-5'>
        ...
        <button
          ...
          className='w-max px-4 py-2 h-[30px] sm:h-[40px] bg-gradient font-semibold rounded-lg shadow-sm cursor-pointer flex justify-center items-center p-2'>

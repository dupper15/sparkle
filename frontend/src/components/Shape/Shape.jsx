          ...
          {draggingShape ? (
              <div
                  style={{
                    ...
                    height: "90px",
                    backgroundColor: "#e5e5e5",
                    ...(draggingShape.shapeType === "circle" && { borderRadius: "50%" }),
                    ...(draggingShape.shapeType === "triangle" && { clipPath: "polygon(50% 0,100% 100%, 0 100%)" }),
                    ...(draggingShape.shapeType === "invertedTriangle" && { clipPath: "polygon(50% 100%, 0 0, 100% 0)" }),
                    ...(draggingShape.shapeType === "pentagon" && { clipPath: "polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)" }),
                    ...(draggingShape.shapeType === "hexagon" && { clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }),
                    ...(draggingShape.shapeType === "octagon" && { clipPath: "polygon(50% 0%, 85% 15%, 100% 50%, 85% 85%, 50% 100%, 15% 85%, 0% 50%, 15% 15%)" }),
                    ...(draggingShape.shapeType === "arrowUp" && { clipPath: "polygon(50% 0%, 100% 50%, 75% 50%, 75% 100%, 25% 100%, 25% 50%, 0% 50%)" }),
                    ...(draggingShape.shapeType === "arrowDown" && { clipPath: "polygon(50% 100%, 100% 50%, 75% 50%, 75% 0%, 25% 0%, 25% 50%, 0% 50%)" }),
                    ...(draggingShape.shapeType === "arrowRight" && { clipPath: "polygon(0% 50%, 50% 0%, 50% 25%, 100% 25%, 100% 75%, 50% 75%, 50% 100%)" }),
                    ...(draggingShape.shapeType === "arrowLeft" && { clipPath: "polygon(100% 50%, 50% 0%, 50% 25%, 0% 25%, 0% 75%, 50% 75%, 50% 100%)" }),
                  }}
              ></div>
          ) : null}
        </DragOverlay>

...
const Background = ({ setBackground }) => {
	...
	return (
		<div className='flex flex-col h-full relative'>
			...
			<div className='grid grid-cols-2 gap-2 w-full h-max overflow-y-auto pb-20 scrollbar-hide image-container'>
				{backgrounds.map((background, i) => (
					<div
						...
						style={{
							backgroundImage: background.background_url ? `url(${background.background_url})` : 'none',
					...
					>
						...
						{hoveredBackground === background._id && background._id !== 'default' && (
							<div

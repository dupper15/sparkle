    ...
    <div className='flex items-center justify-between w-full h-[50px] px-5 py-8'>
      ...
      <div className='flex items-center justify-center gap-5 px-3 py-10'>
        <button
          ...
          className='w-[80px] h-[40px] bg-white font-semibold rounded-lg shadow-sm cursor-pointer border-black flex justify-center items-center p-2 transition-all hover:bg-slate-200 duration-500'>

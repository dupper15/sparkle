...
const CreateComponent = ({info, removeComponent, onClick, selectedComponents}) => {
    ...
    const handleTransformMouseDown = (e) => {
        ...
        if (!isResizing) {
            ...
            startTransformRef.current = {
                x: e.clientX, y: e.clientY, rotate: deg, // Khởi tạo góc quay ban đầu là 0 độ
            };
        }
    };
    ...
    const getShapeStyle = (info) => {
        ...
        const shapeStyles = {
            rect: {}, circle: {borderRadius: "50%"}, triangle: {
                clipPath: "polygon(50% 0, 100% 100%, 0 100%)", position: "relative",
            }, invertedTriangle: {clipPath: "polygon(50% 100%, 0 0, 100% 0)"}, pentagon: {

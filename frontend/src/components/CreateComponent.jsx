...
const CreateComponent = ({ info, removeComponent, onClick, selectedComponents, isFocused, userNames }) => {
	...
	return (
		...
		>
			...
			<div
				...
				className='resizable-component group hover:border-[2px] hover:border-indigo-500 relative'
			></div>

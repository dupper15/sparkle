...
const ChatBox = ({ toggleChatBox }) => {
  ...
  return (
    <div className='flex flex-col w-[200px] h-[350px] sm:w-[400px] sm:h-[500px] bg-[#EEEAEA] dark:bg-slate-900 dark:text-white fixed bottom-3 right-3 shadow-lg rounded-lg overflow-hidden'>

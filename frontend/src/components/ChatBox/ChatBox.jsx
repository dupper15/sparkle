...
const ChatBox = ({ toggleChatBox }) => {
	...
	const mutation = useMutation({
		...
		onSuccess: (data) => {
			console.log(data);
			if (data.startsWith('https://fal.media')) {
				setImageAnswer(data || '');
			} else {
				setBotAnswer(data || '');
			}
	...
	return (
		<div className='flex flex-col w-[300px] h-[400px] sm:w-[400px] sm:h-[500px] bg-[#EEEAEA] dark:bg-slate-900 dark:text-white fixed bottom-3 right-3 shadow-lg rounded-lg overflow-hidden'>

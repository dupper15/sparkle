...
export const createAndAddComponentToCanvas = async (canvasId, componentType, componentData) => {
    try {
        ...
        const canvasResponse = await ComponentService.addComponentToCanvas(canvasId, componentId);
